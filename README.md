...
**Комментарий:**  добавил в compose ```user: "1000:1000"``` для telegraf и chronograf и сделал для всех файлов и деректорий в директории sandbox права 777 (последнее вряд ли было нужно)
#
